...
namespace L1.Controllers
{
    public class UserProfilesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,Key,Name,CurrentSequencePosition,DifficultyLevel")] UserProfile userProfile)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Key,Name,CurrentSequencePosition,DifficultyLevel")] UserProfile userProfile)
        {
